...
local config = {
    cmd = {
        ...
        -- "-configuration", "/home/devansh/.local/share/nvim/mason/packages/jdtls/config_linux",
    ...
    init_options = {
        bundles = {
            vim.fn.glob(
                home .. "/java-debug/com.microsoft.java.debug.plugin/target/com.microsoft.java.debug.plugin-*.jar", 1)
        },
    },
    ...
    on_attach = function(client, bufnr)
        ...
        -- Setup DAP for Java debugging
        require('jdtls').setup_dap({ hotcodereplace = 'auto' })
        require('jdtls.dap').setup_dap_main_class_configs()

        -- Java-specific keybindings (avoid conflict with treesj)
